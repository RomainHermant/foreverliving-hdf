<nav style="z-index: 999" class="shadow flex items-center justify-between lg:flex-wrap p-6 fixed bg-white w-full h-24 px-10">
    ...
    <div class="block flex-grow lg:flex lg:items-center lg:w-auto">
        <div class="text-sm lg:flex-grow text-black text-xl">
            ...
            <a href="{{ route('products') }}" class="text-gray-800 hover:text-gray-900 rounded px-2 py-1 hover:bg-gray-200 transition-all duration-200 lg:inline-block lg:mt-0">
                Produit
            </a>
        </div>
    </div>
    <div class="flex items-center">
        ...
        @auth
            <a href="{{ route('admin.dashboard') }}" class="inline-block text-base px-4 py-2 leading-none bg-yellow-400 text-black rounded-full hover:bg-yellow-500 lg:mt-4 lg:mt-0">Administration</a>
        @endauth
    </div>
</nav>
